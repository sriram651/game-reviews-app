...
export default function VoteActions({ reviewId, upVotes, downVotes, userVoteDetails }) {
    ...
    return (
        <div className="votes-section w-max max-w-full py-2 flex justify-start items-center gap-3">
            <button
                className={`w-max py-2 flex justify-center items-center gap-1 font-medium rounded-xl disabled:opacity-50 disabled:cursor-default transition-all duration-100 ease-in-out`}
                onClick={handleUpVote}
                disabled={upVoteLoading}
            >
                <ThumbsUpIcon active={userVote?.isUpVoted} /> {upVoteCount}
            </button>
            <button
                className={`w-max py-2 flex justify-center items-center gap-1 font-medium rounded-xl disabled:opacity-50 disabled:cursor-default transition-all duration-100 ease-in-out`}
            ...
            >
                <ThumbsDownIcon active={userVote?.isDownVoted} /> {downVoteCount}
            </button>
        </div>
    )
}
